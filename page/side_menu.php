              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a href="index.php"><span class="fa-home fa"></span> Dashboard 
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa fa-paint-brush"></span> Homepage
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="topnav.html">Edit Tulisan</a></li>
                        <li><a href="boxed.html">Wallpaper</a></li>
                      </ul>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                      ...
                      <ul class="nav nav-list tree">
                        ...
                        <li><a href="list.user.php">Lihat Semua</a></li>
                      </ul>
                    </li>
                      <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa fa-envelope"></span> Surat Masuk
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                      <li><a href="dokumen/template data surat masuk.xlsx">Download Template</a></li>
                        <li><a href="list.surat.masuk.php">Lihat Semua</a></li>
                      </ul>
                    </li>
                         <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa fa-envelope-o"></span> Surat Keluar
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
