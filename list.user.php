          ...
          <div class="panel-body">
            <div class="col-md-12">
              ...
              <p class="animated fadeInDown">
                Data User <span class="fa-angle-right fa"></span> Lihat Semua
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div role="document" class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <input type="text" name="username" class="form-control" placeholder="Username" minlength="8" required>
                        </div>
                          <div class="form-group">
                        <label>Password</label>
                        <input type="text" name="password" class="form-control" placeholder="******" minlength="8" required>
                        </div>
                           <div class="form-group">
                    ...
                    <tbody>
                     ...
                     while($d = mysqli_fetch_array($data)){
                      ...
                      <td><?php echo $d['hak_akses']; ?></td>
                          ...
                          <td align="center"><a href="#" data-id="<?php echo $d['id_user']; ?>"class="btn btn-round btn-detail btn-warning btn-sm"data-toggle="modal" data-target="#detailPesan"><i class="fa fa-pencil"></i> Edit</a></td>
                        <td align="center"><a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ?')){ location.href='crud/hapus_data_user.php?id_user=<?php echo $d['id_user']; ?>' }" class="btn btn-round btn-danger"><i class="fa fa-trash"></i> Hapus</a></td>
                      <?php 
                  }
                  ?>
                      </tr> 
...
<script type="text/javascript">
    $('.btn-detail').click(function(){
      $.get('crud/detail_user.php?id_user='+$(this).data('id'),function(data){
        console.log(data)
